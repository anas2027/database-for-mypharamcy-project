...
Route::post('/getuserdetail',[Usercontroller::class,'show']);
...
Route::group(['middleware' => ['auth']], function() {
 ...
 Route::post('/addmed',[MedicineController::class,'createmed']);
  ...
  Route::post('/walletget', [WalletwarehouseController::class,'show']);
...
//..................pharamcy.......................................................
 ...
 Route::put('/pharmacys',[PharmacyController::class,'update']);
...
Route::get('/exp',[MedicineController::class,'exp']);
 ...
 Route::post('/minusquantity',[MedicineController::class,'qunatityMinus']);
...
Route::post('/getmedPharmacybycategory',[MedPharmacyController::class,'category']);
...
///////////////////////////// DashBoard //////////////////////////////////////////
 ...
 // most warehouse get order
 Route::get('/count',[WarehouseController::class,'count']);
  
 //most userbuyfrom pharamacy
 Route::post('/customer',[OrderController::class,'customer']);


// most med buyfroom user
Route::post('/count/med',[OrderDetailController::class,'count']);

Route::post('/search/warehouse',[WarehouseController::class,'search']);

Route::post('/search/users',[Usercontroller::class,'search']);

Route::post('/search/pharmacy',[PharmacyController::class,'search']);
